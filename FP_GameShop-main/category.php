    ...
    <section class="section-kategori container-fluid">
        <div class="container mt-5 mb-5 p-4 bg-light rounded">
            ...
            <div class="table-responsive" >
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="edit_category.php?id=<?php echo $row['category_id']?>">Edit</a> || <a href="delete.php?idk=<?php echo $row['category_id']?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a></td>
                  </tr>
                  <?php }}else{ ?>
                    <tr>
              ...
              <a href="add_category.php" class="btn btn-outline-success mr-2">Tambah Kategori</a>
            </div>
        </div>
    </section>
