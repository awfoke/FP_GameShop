    ...
    <section class="section-produk container-fluid">
        <div class="container mt-5 mb-5 p-4 bg-light rounded">
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="product/<?php echo $row['product_image'] ?>" target="_blank"><img src="product/<?php echo $row['product_image'] ?>"</a></td>
                    <td><?php echo ($row['product_status']) == 0? 'Tidak Aktif':'Aktif'; ?></td>
                    <td><a href="edit_product.php?id=<?php echo $row['product_id']?>">Edit</a> || <a href="delete.php?idp=<?php echo $row['product_id']?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a></td>
                  </tr>
                  <?php }}else{ ?>
                    <tr>
              ...
              <a href="add_product.php" class="btn btn-outline-success mr-2">Tambah Produk</a>
            </div>
        </div>
    </section>
