...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jan 2022 pada 08.19
...
INSERT INTO `tb_user` (`user_id`, `user_name`, `username`, `password`, `user_email`) VALUES
(1, 'user', 'username', '202cb962ac59075b964b07152d234b70', 'aldi.prabowo@students.amikom.ac.id');
